...
export default function Register() {
    ...
    const handleChange = (prop: string) => (event: React.ChangeEvent<HTMLInputElement>) => {
        if (prop === 'age' && Number(event.target.value) < 0) return;
        ...
        >
            ...
            <AnimatePresence>
                <motion.div
                    ...
                    style={{ zIndex: 10, width: '100%', maxWidth: '440px', padding: '16px' }}
                >
                    <Paper
                        elevation={24}
                        sx={{
                    ...
                    >
                        ...
                        <Box component="form" sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: { xs: 1.5, md: 2 } }}>
                                ...
                                <TextField
                                    ...
                                    placeholder={
                                        field === 'username' ? 'Nombre de usuario' :
                                            field === 'email' ? 'Correo electrónico' : 'Edad'
                                    }
                                    variant="outlined"
                                    type={field === 'age' ? 'number' : 'text'}
                                    inputProps={field === 'age' ? { min: 0 } : undefined}
                                        ...
                                        input: {
                                            startAdornment: (
                                                <InputAdornment position="start">
                                                    {field === 'username' && <PersonIcon sx={{ color: PALETTE.Gold }} />}
                                                    {field === 'email' && <EmailIcon sx={{ color: PALETTE.Gold }} />}
                                                    {field === 'age' && <CakeIcon sx={{ color: PALETTE.Gold }} />}
                                                </InputAdornment>
                                            ),
                                        }
                                    }}
